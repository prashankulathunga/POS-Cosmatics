...
export function StockAdjustmentDialog({
    ...
    product: InventoryAdjustProduct;
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Update <span className="font-medium text-slate-900">{product.name}</span>{' '}
                        and store the movement reason.
                    </DialogDescription>
                </DialogHeader>
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            {...form.register('quantityChange', {
                                valueAsNumber: true,
                                validate: (value) => value !== 0 || 'Quantity change cannot be 0',
                            })}
                        />
                        <p className="text-sm text-slate-500">
                            Use a positive number to add stock, negative to reduce stock.
                        </p>
                    </div>
                    <div className="space-y-2">
                        ...
                        <Input
                            id="note"
                            placeholder="Damaged items, count correction, restock..."
                            {...form.register('note')}
                        />
                    </div>
