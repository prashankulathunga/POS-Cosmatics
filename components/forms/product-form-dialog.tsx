    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Save a product with barcode, pricing, and stock settings.</DialogDescription>
        </DialogHeader>
        ...
        <form className="grid gap-4 md:grid-cols-2" onSubmit={onSubmit}>
          ...
          <div className="space-y-2">
            ...
            <Input id="barcode" placeholder="Leave blank to auto-generate" {...form.register("barcode")} />
            {form.formState.errors.barcode ? (
              <p className="text-sm text-rose-600">{form.formState.errors.barcode.message}</p>
            ) : null}
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input id="buyingPrice" type="number" step="0.01" {...form.register("buyingPrice")} />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input id="lowStockLimit" type="number" {...form.register("lowStockLimit")} />
          </div>
          ...
          <div className="flex items-center justify-between rounded-2xl bg-slate-50 px-4 py-3 md:col-span-2">
            <div>
              ...
              <p className="text-sm text-slate-500">Inactive products stay in history but disappear from sale search.</p>
            </div>
            <Controller
              control={form.control}
              name="isActive"
